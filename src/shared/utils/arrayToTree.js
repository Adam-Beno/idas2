...
/*
  source: https://www.npmjs.com/package/performant-array-to-tree
*/
export default (items, config) => {
  ...
  for (let _i = 0, items1 = items; _i < items1.length; _i += 1) {
    const item = items1[_i];
    ...
    lookup[itemId] = merge(lookup[itemId], item);
