...
class Category extends Component {
  ...
  handleEdit(id) {
    this.props.redirect(`/categories/edit/${id}`);
  }
      ...
      <div>
        ...
        <Card className={classes.card}>
          <CardContent className={classes.root}>
            <Button fab mini color="primary" aria-label="add" className={classes.addButton} onClick={() => props.redirect('/categories/add-form')}>
              <AddIcon />
            </Button>
